...
export const UtilizationCard = () => {
  ...
  const podPopover = React.useCallback(
    React.memo<TopConsumerPopoverProp>(({ current }) => (
      <ConsumerPopover
        title={t('ceph-storage-plugin~Pod count')}
        current={current}
  ...
  const networkInPopover = React.useCallback(
    React.memo<TopConsumerPopoverProp>(({ current }) => (
      <ConsumerPopover
        title={t('ceph-storage-plugin~Network in')}
        current={current}
  ...
  const networkOutPopover = React.useCallback(
    React.memo<TopConsumerPopoverProp>(({ current }) => (
      <ConsumerPopover
        title={t('ceph-storage-plugin~Network out')}
        current={current}
  ...
  return (
    <DashboardCard data-test-id="utilization-card">
      <DashboardCardHeader>
        <DashboardCardTitle>{t('ceph-storage-plugin~Cluster utilization')}</DashboardCardTitle>
        <Dropdown
          items={Duration(t)}
      ...
      <UtilizationBody timestamps={timestamps}>
        ...
        <PrometheusMultilineUtilizationItem
          title={t('ceph-storage-plugin~Network transfer')}
